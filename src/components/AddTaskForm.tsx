    ...
    <div className="space-y-6">
      ...
      <form className="space-y-5" onSubmit={formik.handleSubmit}>
        <div className="grid w-full max-w-sm items-center gap-1.5">
          ...
          <Input className={`${formik.touched.name && formik.errors.name ? 'border-error focus-visible:ring-error' : ''}`} type="text" id="name" placeholder="Name" {...formik.getFieldProps('name')} />
        </div>
        <div className="grid w-full gap-1.5">
          ...
          <Textarea className={`${formik.touched.description && formik.errors.description ? 'border-error focus-visible:ring-error' : ''}`} placeholder="Description of the todo" id="description" {...formik.getFieldProps('description')} />
        </div>
