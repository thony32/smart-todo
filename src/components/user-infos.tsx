        ...
        <div className="user-infos">
            {avatar_url && (
                <div className="flex gap-4 items-center relative">
                    <div
                        onClick={getMailNotify}
                        className="absolute -top-1 -left-4 sm:-left-6 tooltip tooltip-bottom cursor-pointer"
                        data-tip="Mail notifier"
                    >
                        <svg
                            className={`w-5 cursor-pointer hover:rotate-12 duration-200 ${isGetMailNotify && "stroke-success scale-110"}`}
                            fill="none"
                            viewBox="0 0 24 24"
                            strokeWidth={1.5}
                            stroke="currentColor"
